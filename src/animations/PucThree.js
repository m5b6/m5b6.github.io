...
export default function PucThree() {
  let container = document.getElementById("puc-3d");
  ...
  materials;
  loader.load("./Puc3d/PUC.gltf", function (gltf) {
    ...
    let rotationSpeedY = 0.00118;
    let rotationSpeedZ = 0.0003;
    let directionY = 1;
    let directionZ = 1;
